...
export const strucvarsCsqInfiniteQueryKey = (
  options: Options<StrucvarsCsqData>
): QueryKey<Options<StrucvarsCsqData>> => [createQueryKey('strucvarsCsq', options, true)]

export const strucvarsCsqInfiniteOptions = (options: Options<StrucvarsCsqData>) => {
  return infiniteQueryOptions<
    StrucvarsCsqResponse2,
    StrucvarsCsqError,
    InfiniteData<StrucvarsCsqResponse2>,
    QueryKey<Options<StrucvarsCsqData>>,
    number | Pick<QueryKey<Options<StrucvarsCsqData>>[0], 'body' | 'headers' | 'path' | 'query'>
  >(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<
          QueryKey<Options<StrucvarsCsqData>>[0],
