...
import type {
  ...
  HpoSimTermGeneData,
  HpoSimTermGeneError,
  HpoSimTermGeneResponse,
  HpoSimTermTermData,
  HpoSimTermTermError,
  HpoSimTermTermResponse,
  HpoTermsData,
  HpoTermsError,
  HpoTermsResponse
} from './types.gen'
 ...
 */
export const hpoGenes = <ThrowOnError extends boolean = false>(
  options?: Options<HpoGenesData, ThrowOnError>
) => {
 ...
 */
export const hpoOmims = <ThrowOnError extends boolean = false>(
  options?: Options<HpoOmimsData, ThrowOnError>
) => {
 ...
 * list of genes.
 */
export const hpoSimTermGene = <ThrowOnError extends boolean = false>(
  options: Options<HpoSimTermGeneData, ThrowOnError>
) => {
 ...
 * In the case that there is an error running the server.
 */
export const hpoSimTermTerm = <ThrowOnError extends boolean = false>(
  options: Options<HpoSimTermTermData, ThrowOnError>
) => {
 ...
 * In the case that there is an error running the server.
 */
export const hpoTerms = <ThrowOnError extends boolean = false>(
  options?: Options<HpoTermsData, ThrowOnError>
) => {
